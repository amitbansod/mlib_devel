...
class alveo_u50(YellowBlock):
    def initialize(self):
        self.add_source('infrastructure/alveo_u50_infrastructure.v')
        self.add_source('wbs_arbiter')
        self.provides = ['sys_clk', 'sys_clk90', 'sys_clk180', 'sys_clk270']

    def modify_top(self,top):
        inst = top.get_instance('alveo_u50_infrastructure', 'alveo_u50_infrastructure_inst')
